function [ Mw ] = MinimaxMbasis(Pre , Post , M0, nu , w )


%  Mbasis: This function computes for any observation w, a set, that we
%          denote M(w), whose elements are couple of minimax basis marking and
%          relative j-vectors
%          ****************************************************************
%
%                                  ## SYNTAX ##
...
%          The first column is a matrix that represents the minimax basis marking
...
%***********************************************************************
           Jcurrent =minmaxy(Pre,Post,Mold_i',transition,nu); 
